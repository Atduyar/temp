...
function getDefualtElement(htl){
    ...
    <div class="item">
        <div class="item-plus" onclick="this.parentElement.classList.toggle('open')">
            ...
            <div class="menu">
                <ul>
                    <li onclick="addElementToNext(this, "h1", this.parentElement.parentElement.parentElement.parentElement.document.getElementsByClassName("item-body")[0].children[0].id)">
